...
//             <option value="Mix Peda Boxes">Mix Peda Boxes</option>
//             <option value="Special Namkeen Mixtures">Special Namkeen Mixtures</option>
//             <option value="Festive Gift Packs">Festive Gift Packs</option>
//             <option value="Family Combo Packs">Family Combo Packs</option>
//           </select>
//         </div>
//       </div>
