  ...
  return (
    <>
      <div className="d-flex position-relative">
        ...
        {/* Main Content */}
        <main
          className="min-h-screen p-5 bg-light transition-all duration-300 flex-grow-1"
          style={{ marginLeft: "16rem" }} // ✅ Sidebar width = 64 = 16rem
        >
          <h1 className="mb-4">{selectedCategory} Categories</h1>
                    ...
                    <div className="card-footer bg-white border-0 p-3 d-flex gap-2">
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          console.log(
                            "✅ Navigating to checkout with product:",
                            p
                          );
                          navigate("/checkout", {
                            state: { cart: [{ ...p, qty: 1 }] },
